...
(cl:defmethod cl:initialize-instance :after ((m <AddTwoInts-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddTwoInts-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Lab_2-srv:<AddTwoInts-request> is deprecated: use Lab_2-srv:AddTwoInts-request instead.")))

(cl:ensure-generic-function 'a-val :lambda-list '(m))
(cl:defmethod a-val ((m <AddTwoInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Lab_2-srv:a-val is deprecated.  Use Lab_2-srv:a instead.")
  (a m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <AddTwoInts-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Lab_2-srv:b-val is deprecated.  Use Lab_2-srv:b instead.")
  (b m))
...
(cl:defmethod cl:initialize-instance :after ((m <AddTwoInts-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddTwoInts-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Lab_2-srv:<AddTwoInts-response> is deprecated: use Lab_2-srv:AddTwoInts-response instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <AddTwoInts-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Lab_2-srv:sum-val is deprecated.  Use Lab_2-srv:sum instead.")
  (sum m))
