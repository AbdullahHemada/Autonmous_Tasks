...
"""autogenerated by genpy from Lab_2/AddTwoIntsRequest.msg. Do not edit."""
import codecs
import sys
...
def _get_struct_2q():
    ...
    return _struct_2q
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from Lab_2/AddTwoIntsResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class AddTwoIntsResponse(genpy.Message):
  ...
  _type = "Lab_2/AddTwoIntsResponse"
  _has_header = False  # flag to mark the presence of a Header object
